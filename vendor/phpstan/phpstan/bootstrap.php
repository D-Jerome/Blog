    ...
    final public static function loadClass(string $class): void
    {
        ...
        if (strpos($class, '_PHPStan_') === 0) {
            ...
            if (self::$composerAutoloader === null) {
                self::$composerAutoloader = include 'phar://' . __DIR__ . '/phpstan.phar/vendor/autoload.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/jetbrains/phpstorm-stubs/PhpStormStubsMap.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/react/async/src/functions_include.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/react/promise-timer/src/functions_include.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/react/promise/src/functions_include.php';
                include_once 'phar://' . __DIR__ . '/phpstan.phar/vendor/ringcentral/psr7/src/functions_include.php';
            }
